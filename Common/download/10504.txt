...
namespace Test1.Common_Robot
{
    ...
    public class FlatTabControl : System.Windows.Forms.TabControl
    {
        ...
        internal void DrawControl(Graphics g)
        {
            ...
            //----------------------------
            // fill client area
            Brush br = new SolidBrush(mBackColor); //Color.Green);//
        ...
        internal void DrawTab(Graphics g, TabPage tabPage, int nIndex)
        {
            ...
            else if (this.Alignment == TabAlignment.Right)
            {
                ...
                {
                    pt = new Point[10];
                    pt[0] = new Point(recBounds.Left, (recBounds.Top + recBounds.Bottom) / 2 + 5);
                    pt[1] = new Point(recBounds.Left, recBounds.Top + 3);
                    pt[2] = new Point(recBounds.Right - 5, recBounds.Top + 3);
                    pt[3] = new Point(recBounds.Right, recBounds.Top + 8);
                    pt[4] = new Point(recBounds.Right, recBounds.Bottom - 8);
                    pt[5] = new Point(recBounds.Right - 5, recBounds.Bottom - 3);
                    pt[6] = new Point(recBounds.Left, recBounds.Bottom - 3);
                    pt[7] = new Point(recBounds.Left, (recBounds.Top + recBounds.Bottom) / 2 + 5);
                    pt[8] = new Point(recBounds.Left + 5, (recBounds.Top + recBounds.Bottom) / 2);
                    pt[9] = new Point(recBounds.Left, (recBounds.Top + recBounds.Bottom) / 2 - 5);
                }
                else
                {
                    pt[0] = new Point(recBounds.Left, recBounds.Bottom - 3);
                    pt[1] = new Point(recBounds.Left, recBounds.Top + 3);
                    pt[2] = new Point(recBounds.Right - 5, recBounds.Top + 3);
                    pt[3] = new Point(recBounds.Right, recBounds.Top + 8);
                    pt[4] = new Point(recBounds.Right, recBounds.Bottom - 8);
            ...
            if (bSelected)
            {
                ...
                Brush br2 = new SolidBrush(Color.FromArgb(200, 200, 200));
                g.FillPolygon(br2, pt);
                br2.Dispose();
                //----------------------------
            }
            //----------------------------
            ...
            if (bSelected)
            {
                ...
                switch (this.Alignment)
                {
                    ...
                    case TabAlignment.Left:
                        g.DrawLine(pen, recBounds.Right - 2, recBounds.Top, recBounds.Right - 2, recBounds.Bottom);
                        g.DrawLine(pen, recBounds.Right - 1, recBounds.Top, recBounds.Right - 1, recBounds.Bottom);
                        g.DrawLine(pen, recBounds.Right, recBounds.Top, recBounds.Right, recBounds.Bottom);
                        g.DrawLine(pen, recBounds.Right + 1, recBounds.Top, recBounds.Right + 1, recBounds.Bottom);
                        break;
                    case TabAlignment.Right:
                        int iTop = (recBounds.Top + recBounds.Bottom) / 2 + 3;
                        int iBottom = (recBounds.Top + recBounds.Bottom) / 2 - 3;
                        g.DrawLine(pen, recBounds.Left - 2, iTop, recBounds.Left - 2, iBottom);
                        g.DrawLine(pen, recBounds.Left - 1, iTop, recBounds.Left - 1, iBottom);
                        g.DrawLine(pen, recBounds.Left, iTop+1, recBounds.Left, iBottom-1);
                        g.DrawLine(pen, recBounds.Left + 1,  iTop, recBounds.Left + 1, iBottom);
                        break;
