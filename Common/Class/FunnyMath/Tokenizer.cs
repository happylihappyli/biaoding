    ...
    public class Tokenizer
    {
        ...
        public void NextToken()
        {
            ...
            switch (_currentChar)
            {
                ...
                case '+':
                    NextChar();
                    _currentToken = Token.加;
                    return;

                case '-':
                    NextChar();
                    _currentToken = Token.减;
                    return;

                case '*':
                    NextChar();
                    _currentToken = Token.乘;
                    return;

                case '/':
                    NextChar();
                    _currentToken = Token.除;
                    return;

                case '^':
                    NextChar();
                    _currentToken = Token.次方;
                    return;

                case '(':
                    NextChar();
                    _currentToken = Token.括号左边;
                    return;

                case ')':
                    NextChar();
                    _currentToken = Token.括号右边;
                    return;
