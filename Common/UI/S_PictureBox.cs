...
namespace Test1
{
    public class S_PictureBox : S_UI
    {
        ...
        public S_PictureBox(string name, C_Space space_parent, C_Space space) : 
        ...
        public override Task run_sub()
        {
            ...
            {
                string? value = (string?)pTrain.get_Vars()[read_key].get_obj();
                url = value;
            }
            ...
            Action act = delegate ()
            {
                if (picture_box != null)
                {
                    if (url.StartsWith("@"))
                    {
                        ...
                        {
                            picture_box.Image = (Image)pTrain.get_Vars()[name].get_obj();
                        }
                    }
                    else
                    {
