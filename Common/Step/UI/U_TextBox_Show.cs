...
namespace Test1
{
    public class U_TextBox_Show : C_Node
    {
        ...
        {
            string strDigits=this.read_string(this.digits);
            i_digits=int.Parse(strDigits); 
        }
        ...
        public void run_sub_main()
        {
            ...
            if (msg.StartsWith("@"))
            {
                ...
                if (obj != null)
                {
                    ...
                    {
                        value =Math.Round((double)obj,i_digits).ToString();
                    ...
                    else if (obj.GetType().Name == "C_Point3D")
                    {
                        var a = (C_Point3D)obj;
                        a.digits = 2;
                        value = a.ToString();
