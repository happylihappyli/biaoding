...
namespace ConsoleControl
{
    ...
    public partial class ConsoleControl : UserControl
    {
        ...
        public ConsoleControl()
        {
            ...
            richTextBoxConsole.EnableContextMenu(this);
        }
        ...
        public void scroll_last()
        {
            ...
            richTextBoxConsole.BeginInvoke(act, null);
        }
        ...
        private void richTextBoxConsole_TextChanged_1(object sender, EventArgs e)
        {
