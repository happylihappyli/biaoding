...
namespace JA.Geometry
{
    ...
    public struct Polygon :
        ...
        IEquatable<Polygon>
    {
        public Polygon(string name,bool invert_normal,params Vector3[] nodes)
        {
            this.Name = name;
        ...
        {
            return new Polygon(this.Name,this.Invert_Normal, pose.FromLocal(Nodes));
        }
        ...
        public bool Invert_Normal { get; private set; }
