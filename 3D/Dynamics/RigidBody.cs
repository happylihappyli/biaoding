...
namespace JA.Dynamics
{
    ...
    public class RigidBody : IRender
    {
        ...
        public RigidBody(
            Vector3 center, 
            double mass, Drawing.VisibleSolid solid, Pose pose, Vector33 velocity)
        {
            Mass=mass;
            Graphics = solid;
        ...
        public RigidBody(
            Vector3 center, double mass, Drawing.VisibleSphere sphere, Pose pose, Vector33 velocity)
        {
            Mass=mass;
            Graphics = sphere;
            InitialPosition = pose;
        ...
        public RigidBody(
            Vector3 center, double mass, Drawing.VisibleMesh localMesh, Pose pose, Vector33 velocity)
        {
            Mass=mass;
            Graphics = localMesh;
            InitialPosition = pose;
        ...
        public Vector33 GetMotion(Vector33 momentum, Matrix3 M_C, Vector3 cg)
        {
            ...
            var p = momentum.Translational;//平移
            var L_A = momentum.Rotational;//旋转
