...
namespace JA.Dynamics
{
        ...
        IFormattable
    {
        ...
        public string To_Roll_Pitch_Yaw()
        {
            var yaw = Math.Atan2(2.0 * (data.v.Y * data.v.Z + data.s * data.v.X), data.s * data.s - data.v.X * data.v.X - data.v.Y * data.v.Y + data.v.Z * data.v.Z);
            var pitch = Math.Asin(-2.0 * (data.v.X * data.v.Z - data.s * data.v.Y));
            var roll = Math.Atan2(2.0 * (data.v.X * data.v.Y + data.s * data.v.Z), data.s * data.s + data.v.X * data.v.X - data.v.Y * data.v.Y - data.v.Z * data.v.Z);
